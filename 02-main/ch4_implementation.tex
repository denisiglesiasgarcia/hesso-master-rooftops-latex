...
L'analyse du front de Pareto (Figures ~\ref{fig:ch4_09_performance_vs_parameters_pareto_01_eval_test_iou_mean} et \ref{fig:ch4_08_performance_vs_training_time_pareto_04_eval_test_map_95_mean}) identifient les modèles offrant le meilleur compromis entre performance et complexité selon les métriques visées.
...
Les modèles optimaux identifiés dans la Figure \ref{fig:ch4_08_performance_vs_training_time_pareto_04_eval_test_map_95_mean} sont :
\begin{enumerate}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.05\textwidth]{02-main//figures/ch4/ch4_08_performance_vs_training_time_pareto_04_eval_test_map_95_mean.png}}
    \caption{mAP@0.95 vs nombre de paramètres. Les modèles sur la ligne rouge représentent les solutions optimales.}
    \label{fig:ch4_08_performance_vs_training_time_pareto_04_eval_test_map_95_mean}
\end{figure}

La plupart des modèles optimaux identifiés dans la Figure \ref{fig:ch4_09_performance_vs_parameters_pareto_01_eval_test_iou_mean} utilisent les encodeurs mambaout\_base et mambaout\_small qui offrent un bon compromis entre précision de segmentation et complexité.
