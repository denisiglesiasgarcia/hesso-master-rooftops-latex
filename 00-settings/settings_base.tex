...
\usepackage{tabularray} % long tables with captions
\usepackage{tblr-extras} % tblr extras for tabularray
\UseTblrLibrary{babel} % Use babel for tabularray
\usepackage{makecell} % allows to use \makecell for line breaks in table cells
