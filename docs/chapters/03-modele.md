...
<p class="thesis-caption"><em>Tableau 3.1 — Chiffres-clés orthophotos 2019</em></p>
...
<p class="thesis-caption"><em>Tableau 3.2 — Exemple de types pour la couche des toitures</em></p>
...
<p class="thesis-caption"><em>Tableau 3.4 — Principales colonnes de gdf\_toiture\_ajout\_cat\_sia.parquet</em></p>
...
<p class="thesis-caption"><em>Tableau 3.5 — Description des colonnes du fichier parquet résultat</em></p>
...
<p class="thesis-caption"><em>Tableau 3.6 — YOLOv12-seg modèles testés</em></p>
...
<p class="thesis-caption"><em>Tableau 3.7 — Taille du batch pour chaque type de modèle</em></p>
