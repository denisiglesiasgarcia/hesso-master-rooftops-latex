...
<img src="../assets/figures/A1/A1_01_resume_machine_learning_supervise.webp" style="width:100.0%"  alt="Figure 3.1 — Résumé de machine learning supervisé" />
<figcaption>Figure 3.1 — Résumé de machine learning supervisé</figcaption>
</figure>
...
Cette tâche est identique à celle de <a href="../glossary.html#gloss-stdl"><span data-acronym-label="stdl" data-acronym-form="singular+abbrv">STDL</span></a> présentée à la sous-section *[2.4.1](../chapters/02-analysis.md#subsec:stdl_analyse){reference-type="ref" reference="subsec:stdl_analyse"}*, mais l’approche utilisée sera différente.
...
La segmentation sémantique est une autre option explorée par &#91;[52](../bibliography.md#ref-castello_quantification_2021)&#93; dans la sous-section *[2.4.3](../chapters/02-analysis.md#subsec:castello_quantification_2021){reference-type="ref" reference="subsec:castello_quantification_2021"}*. Ils l’ont utilisée pour exactement la même tâche avec un dataset limité au centre-ville de Genève. Les résultats obtenus avec un IoU supérieur à 0,60 sur leur dataset de test sont très encourageants.

La segmentation sémantique est le type d’algorithme retenu. Les autres pistes explorées mais qui n’ont pas été retenues sont détaillées dans la section *[3.7](#sec:pistes_explorees){reference-type="ref" reference="sec:pistes_explorees"}*.
...
La sous-section *[6.2.2](../appendices/A1-fondamentaux-ml.md#subsec:annexe_ortophotos){reference-type="ref" reference="subsec:annexe_ortophotos"}* parcourt en détail les types d’orthophotos les plus utilisées dans la géomatique.

<figure id="fig:ch3_dataset_methodo_01_orthophoto_2019" data-latex-placement="H">
<img src="../assets/figures/ch3/ch3_dataset_methodo_01_orthophoto_2019.webp" style="width:100.0%"  alt="Figure 3.2 — Orthophotos 2019" />
<figcaption>Figure 3.2 — Orthophotos 2019</figcaption>
</figure>
...
<p class="thesis-caption" markdown="1"><em>Tableau 3.1 — Chiffres-clés orthophotos 2019</em></p>
### Données vectorielles {#données-vectorielles}

Les données vectorielles choisies sont régulièrement mises à jour, il n’y a pas de version par année comme pour les orthophotos. La sous-section *[6.2.4](../appendices/A1-fondamentaux-ml.md#subsec:annexe_donnees_vectorielles){reference-type="ref" reference="subsec:annexe_donnees_vectorielles"}* permet d’avoir un aperçu de ce que sont les données vectorielles.
...
<img src="../assets/figures/ch3/ch3_dataset_methodo_02_batiment_horsol.webp" style="width:100.0%"  alt="Figure 3.4 — Couche vectorielle bâtiments hors-sol" />
<figcaption>Figure 3.4 — Couche vectorielle bâtiments hors-sol</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_dataset_methodo_03_batiment_horsol_toiture.webp" style="width:100.0%"  alt="Figure 3.5 — Couche vectorielle toits des bâtiments" />
<figcaption>Figure 3.5 — Couche vectorielle toits des bâtiments</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_dataset_methodo_04_batiment_horsol_toiture_sp.webp" style="width:100.0%"  alt="Figure 3.6 — Couche vectorielle superstructures des toits des bâtiments" />
<figcaption>Figure 3.6 — Couche vectorielle superstructures des toits des bâtiments</figcaption>
</figure>

Cette couche est présentée ici car c’est ce qu’il y a de plus proche à un recueil systématique des obstacles sur les toitures. Elle ne sera pas utilisée. Son utilisation a été explorée dans la section *[3.7](#sec:pistes_explorees){reference-type="ref" reference="sec:pistes_explorees"}*.
...
<img src="../assets/figures/ch3/ch3_preparation_donnees_01_etl.webp" style="width:95.0%"  alt="Figure 3.7 — Principales étapes de la préparation des données vectorielles" />
<figcaption>Figure 3.7 — Principales étapes de la préparation des données vectorielles</figcaption>
</figure>
...
<p class="thesis-caption" markdown="1"><em>Tableau 3.2 — Exemple de types pour la couche des toitures</em></p>
...
<img src="../assets/figures/ch3/ch3_preparation_donnees_02_bug_celigny.webp" style="width:100.0%"  alt="Figure 3.8 — Problème avec la commune de Céligny" />
<figcaption>Figure 3.8 — Problème avec la commune de Céligny</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_preparation_donnees_03_hors_canton.webp" style="width:115.0%"  alt="Figure 3.9 — Visualisation des toitures hors canton de Genève" />
<figcaption>Figure 3.9 — Visualisation des toitures hors canton de Genève</figcaption>
</figure>
...
<p class="thesis-caption" markdown="1"><em>Code 1 — Filtre <a href="../glossary.html#gloss-egid"><span data-acronym-label="egid" data-acronym-form="singular+short">EGID</span></a></em></p>
...
<p class="thesis-caption" markdown="1"><em>Code 2 — Exemple de conversion entre la destination et la première catégorie <a href="../glossary.html#gloss-sia"><span data-acronym-label="sia" data-acronym-form="singular+short">SIA</span></a></em></p>

La première vérification consiste à s’assurer que tous les <a href="../glossary.html#gloss-egid"><span data-acronym-label="egid" data-acronym-form="singular+short">EGID</span></a> possèdent une catégorie <a href="../glossary.html#gloss-sia"><span data-acronym-label="sia" data-acronym-form="singular+short">SIA</span></a> et à analyser la distribution de ces catégories. Le Code [3](#code:categorie_sia_distribution_verification){reference-type="ref" reference="code:categorie_sia_distribution_verification"} inclut une instruction “assert” qui interrompt le script si tous les <a href="../glossary.html#gloss-egid"><span data-acronym-label="egid" data-acronym-form="singular+short">EGID</span></a> ne disposent pas d’une catégorie assignée.
...
<p class="thesis-caption" markdown="1"><em>Code 3 — Distribution des catégories <a href="../glossary.html#gloss-sia"><span data-acronym-label="sia" data-acronym-form="singular+short">SIA</span></a> et vérification des données.</em></p>

<figure id="fig:ch3_preparation_donnees_categorie_sia_01_barplot" data-latex-placement="H">
<img src="../assets/figures/ch3/ch3_preparation_donnees_categorie_sia_01_barplot.webp" style="width:100.0%"  alt="Figure 3.10 — Distribution des catégories sia pour la couche des bâtiments hors-sol" />
<figcaption>Figure 3.10 — Distribution des catégories <a href="../glossary.html#gloss-sia"><span data-acronym-label="sia" data-acronym-form="singular+short">SIA</span></a> pour la couche des bâtiments hors-sol</figcaption>
</figure>
...
<p class="thesis-caption" markdown="1"><em>Tableau 3.4 — Principales colonnes de gdf\_toiture\_ajout\_cat\_sia.parquet</em></p>
...
<img src="../assets/figures/ch3/ch3_preparation_donnees_orthophotos_01_etl.webp" style="width:100.0%"  alt="Figure 3.11 — Découpe des orthophotos en tuiles 1280x1280 pixels avec recouvrement" />
<figcaption>Figure 3.11 — Découpe des orthophotos en tuiles 1280x1280 pixels avec recouvrement</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_preparation_donnees_orthophotos_02_exemple_decoupe_orthophoto1.webp" style="width:100.0%"  alt="Figure 3.12 — Exemple de découpage d’une orthophoto en tuiles pour une zone urbaine" />
<figcaption>Figure 3.12 — Exemple de découpage d’une orthophoto en tuiles pour une zone urbaine</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_preparation_donnees_orthophotos_03_exemple_decoupe_orthophoto2.webp" style="width:100.0%"  alt="Figure 3.13 — Calepinage des tuiles découpées pour la zone urbaine" />
<figcaption>Figure 3.13 — Calepinage des tuiles découpées pour la zone urbaine</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_preparation_donnees_orthophotos_04a_exemple_decoupe_orthophoto3.webp" style="width:40.0%"  alt="Figure 3.14 — Tuile 258" />
<figcaption>Figure 3.14 — Tuile 258</figcaption>
</figure>

<figure id="fig:ch3_preparation_donnees_orthophotos_04_exemple_decoupe_orthophoto3" data-latex-placement="H">
<img src="../assets/figures/ch3/ch3_preparation_donnees_orthophotos_04_exemple_decoupe_orthophoto3.webp" style="width:90.0%"  alt="Figure 3.15 — Recouvrement pour la tuile 258" />
<figcaption>Figure 3.15 — Recouvrement pour la tuile 258</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_preparation_donnees_orthophotos_05_exemple_decoupe_orthophoto4.webp" style="width:100.0%"  alt="Figure 3.16 — Exemple de découpage d’une orthophoto en tuiles pour une zone rurale" />
<figcaption>Figure 3.16 — Exemple de découpage d’une orthophoto en tuiles pour une zone rurale</figcaption>
</figure>
...
<p class="thesis-caption" markdown="1"><em>Code 4 — Pseudo-code pour la découpe des orthophotos 20000x20000 pixels en tuiles de 1280x1280 pixels</em></p>
...
<p class="thesis-caption" markdown="1"><em>Tableau 3.5 — Description des colonnes du fichier parquet résultat</em></p>
...
<img src="../assets/figures/ch3/ch3_selection_donnees_01_distribution_sia.webp" style="width:100.0%"  alt="Figure 3.18 — Distribution des classes sia dominantes par tuile" />
<figcaption>Figure 3.18 — Distribution des classes <a href="../glossary.html#gloss-sia"><span data-acronym-label="sia" data-acronym-form="singular+short">SIA</span></a> dominantes par tuile</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_selection_donnees_02_taille_bin.webp" style="width:100.0%"  alt="Figure 3.19 — Distribution des surfaces de toitures par intervalles" />
<figcaption>Figure 3.19 — Distribution des surfaces de toitures par intervalles</figcaption>
</figure>
...
La fonction `sample_tiles` (Code [5](#code:echantillonnage_tuiles){reference-type="ref" reference="code:echantillonnage_tuiles"}) implémente cette logique d’échantillonnage avec un paramètre `random_state=42` qui permet la reproductibilité des résultats en fixant la graine du générateur de nombres aléatoires.
...
<p class="thesis-caption" markdown="1"><em>Code 5 — Fonction d’échantillonnage stratifié par groupe</em></p>
...
<p class="thesis-caption" markdown="1"><em>Code 6 — Application de l’échantillonnage stratifié</em></p>
...
<img src="../assets/figures/ch3/ch3_selection_donnees_03_selection_stacked.webp" style="width:100.0%"  alt="Figure 3.20 — Sélection de l’échantillon pour le dataset" />
<figcaption>Figure 3.20 — Sélection de l’échantillon pour le dataset</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_selection_donnees_04_selection_map_sia.webp" style="width:100.0%"  alt="Figure 3.21 — Échantillon sélectionné de 539 tuiles par catégorie sia" />
<figcaption>Figure 3.21 — Échantillon sélectionné de 539 tuiles par catégorie <a href="../glossary.html#gloss-sia"><span data-acronym-label="sia" data-acronym-form="singular+short">SIA</span></a></figcaption>
</figure>
...
Cet outil a été utilisé pour créer un dataset de 45 images dans le cadre d’une des pistes explorées dans la sous-section *[3.7.2.2](#subsubsec:fine_tuning_sam){reference-type="ref" reference="subsubsec:fine_tuning_sam"}*. L’interface utilisateur est assez intuitive et ergonomique.

<figure id="fig:ch3_labellisation_01_outils_01_robolfow" data-latex-placement="H">
<img src="../assets/figures/ch3/ch3_labellisation_01_outils_01_robolfow.webp" style="width:100.0%"  alt="Figure 3.22 — Interface Roboflow" />
<figcaption>Figure 3.22 — Interface Roboflow</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_labellisation_01_outils_02_robolfow_sam.webp" style="width:100.0%"  alt="Figure 3.23 — Exemple d’annotation avec sam dans Roboflow" />
<figcaption>Figure 3.23 — Exemple d’annotation avec <a href="../glossary.html#gloss-sam"><span data-acronym-label="sam" data-acronym-form="singular+abbrv">SAM</span></a> dans Roboflow</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_labellisation_01_outils_03_supervisely_modeles.webp" style="width:97.0%"  alt="Figure 3.24 — Modèles de segmentation disponibles dans Supervisely" />
<figcaption>Figure 3.24 — Modèles de segmentation disponibles dans Supervisely</figcaption>
</figure>

<figure id="fig:ch3_labellisation_01_outils_04_supervisely_segmentation" data-latex-placement="H">
<img src="../assets/figures/ch3/ch3_labellisation_01_outils_04_supervisely_segmentation.webp" style="width:97.0%"  alt="Figure 3.25 — Labellisation avec segmentation dans Supervisely" />
<figcaption>Figure 3.25 — Labellisation avec segmentation dans Supervisely</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_labellisation_02_exemples_01_acrotere1.webp"  alt="Figure 3.26 — Original" />
<figcaption>Figure 3.26 — Original</figcaption>
</figure>
<figure id="fig:ch3_labellisation_02_exemples_01_acrotere2">
<img src="../assets/figures/ch3/ch3_labellisation_02_exemples_01_acrotere2.webp"  alt="Figure 3.27 — Labellisation" />
<figcaption>Figure 3.27 — Labellisation</figcaption>
</figure>
<figcaption>Figure 3.28 — Exemple de labellisation 1</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_labellisation_02_exemples_02_lucarne1.webp"  alt="Figure 3.29 — Original" />
<figcaption>Figure 3.29 — Original</figcaption>
</figure>
<figure id="fig:ch3_labellisation_02_exemples_02_lucarne2">
<img src="../assets/figures/ch3/ch3_labellisation_02_exemples_02_lucarne2.webp"  alt="Figure 3.30 — Labellisation" />
<figcaption>Figure 3.30 — Labellisation</figcaption>
</figure>
<figcaption>Figure 3.31 — Exemple de labellisation 2</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_labellisation_02_exemples_03_solaire1.webp"  alt="Figure 3.32 — Original" />
<figcaption>Figure 3.32 — Original</figcaption>
</figure>
<figure id="fig:ch3_labellisation_02_exemples_03_solaire2">
<img src="../assets/figures/ch3/ch3_labellisation_02_exemples_03_solaire2.webp"  alt="Figure 3.33 — Labellisation" />
<figcaption>Figure 3.33 — Labellisation</figcaption>
</figure>
<figcaption>Figure 3.34 — Exemple de labellisation 3</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_labellisation_02_exemples_04_image_non_annotee.webp" style="width:100.0%"  alt="Figure 3.35 — Exemple d’image sans aucune surface libre disponible" />
<figcaption>Figure 3.35 — Exemple d’image sans aucune surface libre disponible</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_03_overview.webp" style="width:100.0%"  alt="Figure 3.36 — Principales étapes du post-traitement" />
<figcaption>Figure 3.36 — Principales étapes du post-traitement</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_01_exemple_dataset.webp"  alt="Figure 3.37 — Tuile d’exemple" />
<figcaption>Figure 3.37 — Tuile d’exemple</figcaption>
</figure>
<figure id="fig:ch3_postprocessing_dataset_02_exemple_postraitement">
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_02_exemple_postraitement.webp"  alt="Figure 3.38 — Tuile d’exemple après post-traitement" />
<figcaption>Figure 3.38 — Tuile d’exemple après post-traitement</figcaption>
</figure>
<figcaption>Figure 3.39 — Exemple de post-traitement</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_04_data_leakage.webp" style="width:100.0%"  alt="Figure 3.40 — Fuite de données entre datasets" />
<figcaption>Figure 3.40 — Fuite de données entre datasets</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_05_traitement_chevauchement.webp" style="width:115.0%"  alt="Figure 3.41 — Traitement des chevauchements entre tuiles" />
<figcaption>Figure 3.41 — Traitement des chevauchements entre tuiles</figcaption>
</figure>
...
La première étape est réalisée par la fonction `find_overlapping_tiles` (Code [7](#code:post_traitement_detection_tuile_chevauchement){reference-type="ref" reference="code:post_traitement_detection_tuile_chevauchement"}) qui permet d’identifier les paires de tuiles se chevauchent.
...
<p class="thesis-caption" markdown="1"><em>Code 7 — Détection des tuiles qui se chevauchent</em></p>
...
<p class="thesis-caption" markdown="1"><em>Code 9 — Masquage sélectif</em></p>
...
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_06_kfold.webp" style="width:115.0%"  alt="Figure 3.42 — Répartition datasets" />
<figcaption>Figure 3.42 — Répartition datasets</figcaption>
</figure>
...
La fonction `create_stratified_dataset_splits` (Code [10](#code:post_traitement_stratification){reference-type="ref" reference="code:post_traitement_stratification"}) permet de réaliser cette stratification.
...
<p class="thesis-caption" markdown="1"><em>Code 10 — Stratification pour la répartition des données annotées</em></p>
...
Le meilleur résultat (Code [11](#code:post_traitement_stratification_resultats){reference-type="ref" reference="code:post_traitement_stratification_resultats"}) est obtenu à l’itération 84, malgré des essais avec plus de 10000 itérations.
...
<p class="thesis-caption" markdown="1"><em>Code 11 — Résultats fonction `create_stratified_dataset_splits`</em></p>
...
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_07_validation.webp" style="width:105.0%"  alt="Figure 3.43 — Validation de la distribution des datasets" />
<figcaption>Figure 3.43 — Validation de la distribution des datasets</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_08_validation_chevauchement_droite1.webp"  alt="Figure 3.44 — Tuile avec chevauchement à droite (rouge)" />
<figcaption>Figure 3.44 — Tuile avec chevauchement à droite (rouge)</figcaption>
</figure>
<figure id="fig:ch3_postprocessing_dataset_09_validation_chevauchement_droite2">
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_09_validation_chevauchement_droite2.webp"  alt="Figure 3.45 — Tuile avec chevauchement à gauche (bleu)" />
<figcaption>Figure 3.45 — Tuile avec chevauchement à gauche (bleu)</figcaption>
</figure>
<figure id="fig:ch3_postprocessing_dataset_10_validation_chevauchement_droite3">
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_10_validation_chevauchement_droite3.webp"  alt="Figure 3.46 — Tuile avec chevauchement à droite avec annotations (rouge)" />
<figcaption>Figure 3.46 — Tuile avec chevauchement à droite avec annotations (rouge)</figcaption>
</figure>
<figure id="fig:ch3_postprocessing_dataset_11_validation_chevauchement_droite4">
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_11_validation_chevauchement_droite4.webp"  alt="Figure 3.47 — Tuile avec chevauchement à gauche avec annotations (bleu)" />
<figcaption>Figure 3.47 — Tuile avec chevauchement à gauche avec annotations (bleu)</figcaption>
</figure>
<figcaption>Figure 3.48 — Cas chevauchement tuile à droite</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_12_validation_chevauchement_bas1.webp"  alt="Figure 3.49 — Tuile avec chevauchement en bas (rouge)" />
<figcaption>Figure 3.49 — Tuile avec chevauchement en bas (rouge)</figcaption>
</figure>
<figure id="fig:ch3_postprocessing_dataset_13_validation_chevauchement_bas2">
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_13_validation_chevauchement_bas2.webp"  alt="Figure 3.50 — Tuile avec chevauchement en haut (bleu)" />
<figcaption>Figure 3.50 — Tuile avec chevauchement en haut (bleu)</figcaption>
</figure>
<figure id="fig:ch3_postprocessing_dataset_14_validation_chevauchement_bas3">
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_14_validation_chevauchement_bas3.webp"  alt="Figure 3.51 — Tuile avec chevauchement en bas avec annotations (rouge)" />
<figcaption>Figure 3.51 — Tuile avec chevauchement en bas avec annotations (rouge)</figcaption>
</figure>
<figure id="fig:ch3_postprocessing_dataset_15_validation_chevauchement_bas4">
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_15_validation_chevauchement_bas4.webp"  alt="Figure 3.52 — Tuile avec chevauchement en haut avec annotations (bleu)" />
<figcaption>Figure 3.52 — Tuile avec chevauchement en haut avec annotations (bleu)</figcaption>
</figure>
<figcaption>Figure 3.53 — Cas chevauchement tuile en bas</figcaption>
</figure>
...
La vérification suivante concerne la taille des images qui doivent toutes avoir des dimensions de si pixels. Cependant, comme indiqué précédemment dans la sous-section *[3.5.1.2](#subsubsec:decoupe_orthophoto_tuile){reference-type="ref" reference="subsubsec:decoupe_orthophoto_tuile"}*, certaines tuiles situées aux extrémités droites et inférieures de l’orthophoto ne respectent pas ce prérequis en raison des contraintes géométriques liées au découpage de la zone d’étude. Un découpage uniforme des orthophotos a été privilégié plutôt que d’avoir des tuiles s’étendant sur plusieurs orthophotos adjacentes.
...
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_16_verification_taille1.webp"  alt="Figure 3.54 — Tuile (ligne pointillée jaune) avec bandes noires" />
<figcaption>Figure 3.54 — Tuile (ligne pointillée jaune) avec bandes noires</figcaption>
</figure>
<figure id="fig:ch3_postprocessing_dataset_17_verification_taille2">
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_17_verification_taille2.webp"  alt="Figure 3.55 — Annotations (ligne pointillée jaune) avec bandes noires" />
<figcaption>Figure 3.55 — Annotations (ligne pointillée jaune) avec bandes noires</figcaption>
</figure>
<figure id="fig:ch3_postprocessing_dataset_18_verification_taille3">
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_18_verification_taille3.webp"  alt="Figure 3.56 — Tuile et annotations (ligne pointillée jaune) avec bandes noires" />
<figcaption>Figure 3.56 — Tuile et annotations (ligne pointillée jaune) avec bandes noires</figcaption>
</figure>
<figcaption>Figure 3.57 — Ajout de bandes noires pour convertir les tuiles et annotations (ligne pointillée jaune) au format 1280x1280 pixels</figcaption>
</figure>
...
Finalement, l’algorithme utilisé pour la distribution des données annotées en datasets vise une répartition optimale malgré la difficulté de réaliser une stratification avec double critère. Le coefficient de variation obtenu se situe à 8.8% pour la surface et 8.6% pour la classe, soit en dessous de l’objectif de 10% (Code [11](#code:post_traitement_stratification_resultats){reference-type="ref" reference="code:post_traitement_stratification_resultats"}).
...
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_19_distribution_barchart_surface.webp" style="width:100.0%"  alt="Figure 3.58 — Distribution des intervalles de surface par dataset" />
<figcaption>Figure 3.58 — Distribution des intervalles de surface par dataset</figcaption>
</figure>

<figure id="fig:ch3_postprocessing_dataset_20_distribution_barchart_classe" data-latex-placement="H">
<img src="../assets/figures/ch3/ch3_postprocessing_dataset_20_distribution_barchart_classe.webp" style="width:105.0%"  alt="Figure 3.59 — Distribution des classes sia par dataset" />
<figcaption>Figure 3.59 — Distribution des classes <a href="../glossary.html#gloss-sia"><span data-acronym-label="sia" data-acronym-form="singular+short">SIA</span></a> par dataset</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_architecture_01_architecture_unet.webp" style="width:105.0%"  alt="Figure 3.60 — Architecture U-Net [86]" />
<figcaption>Figure 3.60 — Architecture U-Net <span class="citation" data-cites="ronneberger_u-net_2015">[<a href="../bibliography.html#ref-ronneberger_u-net_2015" role="doc-biblioref">86</a>]</span></figcaption>
</figure>
...
SMP propose plusieurs architectures qui sont déjà prêtes à l’utilisation. Le Code [12](#code:smp_quick_start_model){reference-type="ref" reference="code:smp_quick_start_model"} permet de créer un modèle U-Net de manière simplifiée.
...
<p class="thesis-caption" markdown="1"><em>Tableau 1 — Avantages et inconvénients des architectures proposées dans SMP</em></p>
...
<img src="../assets/figures/ch3/ch36_architecture_02_architecture_taille_decodeur.webp" style="width:100.0%"  alt="Figure 3.61 — Taille des décodeurs des architectures SMP" />
<figcaption>Figure 3.61 — Taille des décodeurs des architectures SMP</figcaption>
</figure>
...
<p class="thesis-caption" markdown="1"><em>Tableau 2 — Avantages et inconvénients des architectures des encodeurs testés</em></p>
...
<img src="../assets/figures/ch3/ch36_architecture_03_backbone_taille_encodeur_famille.webp" style="width:100.0%"  alt="Figure 3.62 — Encodeurs groupés par type d’architecture" />
<figcaption>Figure 3.62 — Encodeurs groupés par type d’architecture</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_architecture_04_backbone_taille_encodeur_ordonnee.webp" style="width:100.0%"  alt="Figure 3.63 — Encodeurs par ordre croissant de paramètres" />
<figcaption>Figure 3.63 — Encodeurs par ordre croissant de paramètres</figcaption>
</figure>
...
YOLO (You Only Look Once) est un algorithme de détection et segmentation instance d’images qui a révolutionné le domaine de la vision par ordinateur. Sa dernière version YOLOv12 est décrite en détail dans *[2.3.1](../chapters/02-analysis.md#subsec:yolov12_attention_centric){reference-type="ref" reference="subsec:yolov12_attention_centric"}*. YOLOv12 dispose de plusieurs modèles pré-entraînés de différentes tailles selon la complexité des images à segmenter. Le Tableau [3.6](#tab:yolov12_modeles_testes){reference-type="ref" reference="tab:yolov12_modeles_testes"} présente les modèles YOLOv12-seg testés.
...
<p class="thesis-caption" markdown="1"><em>Tableau 3.8 — YOLOv12-seg modèles testés</em></p>
...
<p class="thesis-caption" markdown="1"><em>Code 13 — Pipeline augmentation des données</em></p>
...
<img src="../assets/figures/ch3/ch36_augmentations_00a_yolo_exemple1_original.webp"  alt="Figure 3.64 — Image originale" />
<figcaption>Figure 3.64 — Image originale</figcaption>
</figure>
<figure id="fig:ch36_augmentations_00b_yolo_exemple1_mosaic">
<img src="../assets/figures/ch3/ch36_augmentations_00b_yolo_exemple1_mosaic.webp"  alt="Figure 3.65 — Image transformée avec mosaic" />
<figcaption>Figure 3.65 — Image transformée avec <code>mosaic</code></figcaption>
</figure>
<figcaption>Figure 3.66 — Transformation <code>mosaic</code> de YOLO</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_01_squaresymmetry.webp" style="width:100.0%"  alt="Figure 3.67 — Augmentation de données - exemples de symétrie" />
<figcaption>Figure 3.67 — Augmentation de données - exemples de symétrie</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_02_scale.webp" style="width:100.0%"  alt="Figure 3.68 — Augmentation de données - exemples de échelle" />
<figcaption>Figure 3.68 — Augmentation de données - exemples de échelle</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_03_translation.webp" style="width:100.0%"  alt="Figure 3.69 — Augmentation de données - exemples de translation" />
<figcaption>Figure 3.69 — Augmentation de données - exemples de translation</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_04_rotation.webp" style="width:100.0%"  alt="Figure 3.70 — Augmentation de données - exemples de rotation" />
<figcaption>Figure 3.70 — Augmentation de données - exemples de rotation</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_05_flou_gaussien.webp" style="width:100.0%"  alt="Figure 3.71 — Augmentation de données - exemples de flou gaussien" />
<figcaption>Figure 3.71 — Augmentation de données - exemples de flou gaussien</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_06_flou_median.webp" style="width:100.0%"  alt="Figure 3.72 — Augmentation de données - exemples de flou médian" />
<figcaption>Figure 3.72 — Augmentation de données - exemples de flou médian</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_07_flou_motion.webp" style="width:100.0%"  alt="Figure 3.73 — Augmentation de données - exemples de flou “mouvement”" />
<figcaption>Figure 3.73 — Augmentation de données - exemples de flou “mouvement”</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_08_bruit_gaussien.webp" style="width:100.0%"  alt="Figure 3.74 — Augmentation de données - exemples de bruit gaussien" />
<figcaption>Figure 3.74 — Augmentation de données - exemples de bruit gaussien</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_09_bruit_iso.webp" style="width:100.0%"  alt="Figure 3.75 — Augmentation de données - exemples de bruit ISO" />
<figcaption>Figure 3.75 — Augmentation de données - exemples de bruit ISO</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_10_bruit_multiplicatif.webp" style="width:100.0%"  alt="Figure 3.76 — Augmentation de données - exemples de bruit “multiplicatif”" />
<figcaption>Figure 3.76 — Augmentation de données - exemples de bruit “multiplicatif”</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_11_bruit_poivre_et_sel.webp" style="width:100.0%"  alt="Figure 3.77 — Augmentation de données - exemples de bruit “poivre et sel”" />
<figcaption>Figure 3.77 — Augmentation de données - exemples de bruit “poivre et sel”</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_12_effets_meteo_eblouissement.webp" style="width:100.0%"  alt="Figure 3.78 — Augmentation de données - exemples d’effet météo éblouissement" />
<figcaption>Figure 3.78 — Augmentation de données - exemples d’effet météo éblouissement</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_13_effets_meteo_brouillard.webp" style="width:100.0%"  alt="Figure 3.79 — Augmentation de données - exemples d’effet météo brouillard" />
<figcaption>Figure 3.79 — Augmentation de données - exemples d’effet météo brouillard</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch36_augmentations_14_exemples_complets1.webp" style="width:100.0%"  alt="Figure 3.80 — Augmentation de données - exemples complets 1" />
<figcaption>Figure 3.80 — Augmentation de données - exemples complets 1</figcaption>
</figure>

<figure id="fig:ch36_augmentations_15_exemples_complets2" data-latex-placement="H">
<img src="../assets/figures/ch3/ch36_augmentations_15_exemples_complets2.webp" style="width:100.0%"  alt="Figure 3.81 — Augmentation de données - exemples complets 2" />
<figcaption>Figure 3.81 — Augmentation de données - exemples complets 2</figcaption>
</figure>
...
<p class="thesis-caption" markdown="1"><em>Code 14 — Exemple de fichier de configuration d’entraînement pour SMP</em></p>
...
<p class="thesis-caption" markdown="1"><em>Tableau 3.9 — Taille du batch pour chaque type de modèle</em></p>
...
La deuxième étape consiste à créer le modèle en combinant l’architecture sélectionnée (U-Net, FPN, etc.) avec l’encodeur choisi. Le Code [15](#code:ch36_creation_modele_smp){reference-type="ref" reference="code:ch36_creation_modele_smp"} illustre cette initialisation.
...
<p class="thesis-caption" markdown="1"><em>Code 15 — Création et initialisation d’un modèle SMP</em></p>
...
L’optimiseur AdamW est utilisé avec une stratégie de réduction adaptative du taux d’apprentissage. Le Code [16](#code:ch36_optimiseur_smp){reference-type="ref" reference="code:ch36_optimiseur_smp"} présente cette configuration.
...
<p class="thesis-caption" markdown="1"><em>Code 16 — Configuration de l’optimiseur et planificateur</em></p>
...
<p class="thesis-caption" markdown="1"><em>Code 17 — Boucle d’entraînement avec précision mixte et accumulation de gradients</em></p>

La boucle d’entraînement du Code [17](#code:ch36_boucle_entrainement){reference-type="ref" reference="code:ch36_boucle_entrainement"} fonctionne selon le processus suivant :
...
<p class="thesis-caption" markdown="1"><em>Code 18 — Validation croisée à 5 folds</em></p>

La validation croisée du Code [18](#code:ch36_validation_croisee){reference-type="ref" reference="code:ch36_validation_croisee"} fonctionne ainsi:
...
<p class="thesis-caption" markdown="1"><em>Code 19 — Calcul des métriques d’évaluation</em></p>

Les étapes pour le calcul des métriques du Code [19](#code:ch36_calcul_metriques){reference-type="ref" reference="code:ch36_calcul_metriques"} sont les suivantes:
...
<figcaption>Figure 3.82 — Suivi des métriques d’entraînement et de validation</figcaption>
</figure>
...
<figcaption>Figure 3.83 — Schéma classification des toitures</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_piste_exploree_classification_02_image_originale.webp"  alt="Figure 3.84 — Image d’exemple" />
<figcaption>Figure 3.84 — Image d’exemple</figcaption>
</figure>
<figure id="fig:ch3_piste_exploree_classification_03_couche_toiture">
<img src="../assets/figures/ch3/ch3_piste_exploree_classification_03_couche_toiture.webp"  alt="Figure 3.85 — Couche toiture superposée" />
<figcaption>Figure 3.85 — Couche toiture superposée</figcaption>
</figure>
<figure id="fig:ch3_piste_exploree_classification_04_image_resultante">
<img src="../assets/figures/ch3/ch3_piste_exploree_classification_04_image_resultante.webp"  alt="Figure 3.86 — Résultat final" />
<figcaption>Figure 3.86 — Résultat final</figcaption>
</figure>
<figcaption>Figure 3.87 — Exemple de toiture avec un "trou" et sans superstructure</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_piste_exploree_classification_05_classification_intermediaire.webp" style="width:100.0%"  alt="Figure 3.88 — Classification intermédiaire" />
<figcaption>Figure 3.88 — Classification intermédiaire</figcaption>
</figure>

<figure id="fig:ch3_piste_exploree_classification_06_classification_finale" data-latex-placement="H">
<img src="../assets/figures/ch3/ch3_piste_exploree_classification_06_classification_finale.webp" style="width:100.0%"  alt="Figure 3.89 — Classification finale" />
<figcaption>Figure 3.89 — Classification finale</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_piste_exploree_classification_07_resultats_image_exemple.webp"  alt="Figure 3.90 — Image d’exemple" />
<figcaption>Figure 3.90 — Image d’exemple</figcaption>
</figure>
<figure id="fig:ch3_piste_exploree_classification_08_resultats_image_toiture">
<img src="../assets/figures/ch3/ch3_piste_exploree_classification_08_resultats_image_toiture.webp"  alt="Figure 3.91 — Couche des toitures" />
<figcaption>Figure 3.91 — Couche des toitures</figcaption>
</figure>
<figure id="fig:ch3_piste_exploree_classification_10_resultats_image_sp">
<img src="../assets/figures/ch3/ch3_piste_exploree_classification_10_resultats_image_sp.webp"  alt="Figure 3.92 — Couche des superstructures" />
<figcaption>Figure 3.92 — Couche des superstructures</figcaption>
</figure>
<figure id="fig:ch3_piste_exploree_classification_09_resultats_image__toiture_sp">
<img src="../assets/figures/ch3/ch3_piste_exploree_classification_09_resultats_image__toiture_sp.webp"  alt="Figure 3.93 — Couche des toitures et superstructures" />
<figcaption>Figure 3.93 — Couche des toitures et superstructures</figcaption>
</figure>
<figcaption>Figure 3.94 — Exemple de toiture problématique pour la classification</figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_essai_sam_01_image_original.webp"  alt="Figure 3.95 — Image d’exemple" />
<figcaption>Figure 3.95 — Image d’exemple</figcaption>
</figure>
<figure id="fig:ch3_essai_sam_02_ROI">
<img src="../assets/figures/ch3/ch3_essai_sam_02_ROI.webp"  alt="Figure 3.96 — Zone d’intérêt (ROI)" />
<figcaption>Figure 3.96 — Zone d’intérêt (ROI)</figcaption>
</figure>
<figure id="fig:ch3_essai_sam_03_200_masks">
<img src="../assets/figures/ch3/ch3_essai_sam_03_200_masks.webp"  alt="Figure 3.97 — Polygones segmentés (200)" />
<figcaption>Figure 3.97 — Polygones segmentés (200)</figcaption>
</figure>
<figure id="fig:ch3_essai_sam_04_194_filtered_masks">
<img src="../assets/figures/ch3/ch3_essai_sam_04_194_filtered_masks.webp"  alt="Figure 3.98 — Polygone segmentés filtrés (194)" />
<figcaption>Figure 3.98 — Polygone segmentés filtrés (194)</figcaption>
</figure>
<figure id="fig:ch3_essai_sam_05_filtered_masks_overlay">
<img src="../assets/figures/ch3/ch3_essai_sam_05_filtered_masks_overlay.webp"  alt="Figure 3.99 — Mise en évidence des polygones filtrés" />
<figcaption>Figure 3.99 — Mise en évidence des polygones filtrés</figcaption>
</figure>
<figure id="fig:ch3_essai_sam_06_une_zone_libre">
<img src="../assets/figures/ch3/ch3_essai_sam_06_une_zone_libre.webp"  alt="Figure 3.100 — Espace libre" />
<figcaption>Figure 3.100 — Espace libre</figcaption>
</figure>
<figcaption>Figure 3.101 — Essai d’utilisation de <a href="../glossary.html#gloss-sam"><span data-acronym-label="sam" data-acronym-form="singular+abbrv">SAM</span></a></figcaption>
</figure>
...
<img src="../assets/figures/ch3/ch3_piste_exploree_classification_11_fine_tuning_dataset.webp" style="width:100.0%"  alt="Figure 3.102 — Image du dataset pour le fine-tuning sam" />
<figcaption>Figure 3.102 — Image du dataset pour le fine-tuning <a href="../glossary.html#gloss-sam"><span data-acronym-label="sam" data-acronym-form="singular+abbrv">SAM</span></a></figcaption>
</figure>
